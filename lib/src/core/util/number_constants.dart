abstract class NumberConstants {
  ...
  static const double movieDecoratorBorderWidth = 3.0;
  static const double movieDecoratorPadding = 10.0;

  static const double movieCardSizedBox = 10.0;
  static const double movieCardBorderRadius = 25.0;
  static const double movieCardCachedNetworkImageSize = 130.0;
  static const double movieCardTitleTextStyleFontSize = 20.0;
